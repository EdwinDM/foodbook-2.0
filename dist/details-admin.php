<?php
    ...
    if(isset($_SESSION["isLoggedIn"])){
        ...
        $featured_recipes = $database->select("tb_revision_recipes","*",[
            "recipe_is_featured" => 1
        ]);

        $recipe = $database->select("tb_revision_recipes",[
            ...
            "tb_revision_recipes.id_recipe" => $_GET["id_recipe"]
        ]);

        //related recipes
        $related_recipes = $database->select("tb_revision_recipes",[
            "[><]tb_recipe_category"=>["id_recipe_category" => "id_recipe_category"],
            "[><]tb_recipe_levels"=>["id_recipe_level" => "id_recipe_level"],
        ],[
            "tb_revision_recipes.id_recipe",
            ...
            "tb_revision_recipes.id_recipe_category" => $recipe[0]["id_recipe_category"],
            'LIMIT' => 5
        ]);
    }else{
                                ...
                                <div class="details-data">
                                    <div class="details-info">
                                        ...
                                        <div class="card-likes mt-3">
                                            <a type="button"
                                                href="likes-admin.php?id_recipe=<?php echo $recipe[0]["id_recipe"]; ?>"><i
