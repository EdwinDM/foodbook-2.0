...
<body>
    ...
    <form class="bg-base d-flex" action="login.php" method="post">
        <nav class="container-base d-flex justify-content-center align-items-center">
            <div class="login-data">
                <h2 class="text-center title-mdxl3 text-black mtl mv-title mt-mv2">Inicia Sesión</h2>
                <div class="d-flex justify-content-center mt-m mt-mv1">
