...
<!-- nav menu -->
        ...
        <section id="recetas" class="nav-ten-search container-nav">
            <div class="container-ld d-flex justify-content-center align-items-center">
                <div class="w-100">
                    <div class="d-flex justify-content-between align-items-end title-subidos-container">
                        <?php 
                            if(count($results) > 0){
                                echo "<h2 class='title-options ms-4'>".count($results)." resultado(s) para ".$_GET["keyword"]."</h2>";
                            }else{
                                echo "<h2 class='title-options ms-4'>No hay resultados para ".$_GET["keyword"]."</h2>";
                            }
                        ?>
                    </div>
                    <div class="row row-1">
